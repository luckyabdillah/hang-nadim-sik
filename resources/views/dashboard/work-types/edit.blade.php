            ...
            <form action="{{ route('dashboard.work-types.index') }}/{{ $type->id }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('unit_name') is-invalid @enderror" name="unit_name" id="unit_name" placeholder="Nama Unit" value="{{ old('unit_name', $type->unit_name) }}" required autocomplete="off">
                        @error('unit_name')
                            <div class="invalid-feedback text-start">
                                {{ $message }}
                            </div>
