        ...
        <div class="container py-5 my-5">
            <div class="row g-3 py-5">
                <div class="col-md-6 my-auto">
                    <h1 class="text-primary fw-bold mb-3" style="font-size: 2.5em">Ups! Terjadi kesalahan.</h1>
                    ...
                    <p class="mb-1" style="font-size: 1.1em">Jika masih tidak berhasil, silakan coba lagi nanti.</p>
                </div>
