        ...
        <div class="col-12 col-lg-5 col-xl-5 order-0 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="workPermitLettersStatistics" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="workPermitLettersStatistics">
...
@push('scripts')
    <script>
        (function() {
                                ...
                                labels: {
                                    ...
                                    value: {
                                        ...
                                        formatter: function(val) {
                                            return parseInt(val) / workPermitLettersCount * 100 + '%'
                                        }
                                    },
                                    name: {
                                        offsetY: 20,
            ...
            const workPermitLettersGraphSeriesAverage = workPermitLettersGraphSeries.reduce((sum, val) => sum + val, 0) / workPermitLettersGraphSeries.length;
