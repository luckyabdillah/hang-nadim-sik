...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            @if (in_array('dashboard_work-types_create', $userPermissions))
                    ...
                    @foreach ($workTypes as $type)
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                @if (in_array('dashboard_work-types_edit', $userPermissions))
                                    <a href="{{ route('dashboard.work-types.index') }}/{{ $type->id }}/edit"
